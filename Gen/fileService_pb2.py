...
_METADATAINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='username', full_name='fileservice.metadataInfo.username', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='filename', full_name='fileservice.metadataInfo.filename', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='chunk_id', full_name='fileservice.metadataInfo.chunk_id', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='destination', full_name='fileservice.metadataInfo.destination', index=3,
...
_FILEDATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='chunk_id', full_name='fileservice.FileData.chunk_id', index=3,
...
_FILEINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sequence_no', full_name='fileservice.FileInfo.sequence_no', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
metadataInfo = _reflection.GeneratedProtocolMessageType('metadataInfo', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:fileservice.metadataInfo)
  ))
...
_FILESERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='metadataUpdate',
    full_name='fileservice.Fileservice.metadataUpdate',
    index=9,
    containing_service=None,
    input_type=_METADATAINFO,
    output_type=_ACK,
    serialized_options=None,
  ),
])
